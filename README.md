...
To publish this project to your own GitHub account, follow these simple steps:
...
git commit -m "feat: initial release of 2dto3d panoramic reconstruction pipeline"

# 4. Create a new repository on GitHub (e.g., named '2dto3d')
# Then link your local repository to your remote:
